...
<template>
  <div>
    <div class="py-1 border-b outline-none group" tabindex="0">
      <div
      ...
      >
        ...
        <div
          :class="{ 'rotate-180': isOpen, 'text-red-500': isOpen }"
      ...
      <div v-show="isOpen" class="overflow-hidden transition duration-500 ease">
